...
SIIM_PNEUMOTHORAX = ["Pneumothorax"]
...
VINDR_CXR = [
    ...
    "Pneumonia",
    "Tuberculosis",
]  # select 20 labels with more than 10 samples within the test set.
# 'Other diseases''Other lesion',

CHEXPERT5X200 = ["Atelectasis", "Cardiomegaly", "Consolidation", "Edema", "Pleural Effusion"]
